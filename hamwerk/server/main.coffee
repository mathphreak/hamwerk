...
Meteor.methods
    ...
    onboardMe: (clientOffset) ->
        ...
        assignments = [
            ...
            ["Create an assignment \"due today\"", "6 days from now"]
            ["Create an assignment \"due tomorrow\"", "6 days from now"]
            ["Create an assignment \"due April 4th\" or some other day", "6 days from now"]
            ["Create an assignment \"due June 17, 2015\" or some other date", "6 days from now"]
            ["Create an assignment \"due Friday\" or some other day", "6 days from now"]
            ["Create an assignment \"due Wed\" or some other day", "6 days from now"]
            ["Create an assignment \"due 3 days from now\" or some other number", "6 days from now"]
            ...
            ["Double-click the \"Hamwerk 101\" label in the sidebar and change this class's name to something else", "11 days from now"]
            ["Remember that you can create a new class called \"Hamwerk 101\" to see this all again", "12 days from now"]
            ["Double-click your new name for \"Hamwerk 101,\" delete it, and hit Enter to remove this class", "12 days from now"]
        ]
